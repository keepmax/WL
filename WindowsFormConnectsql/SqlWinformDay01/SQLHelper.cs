...
namespace SqlWinformDay01
{
    public class SQLHelper
    {
        ...
        //6.获取DataAdapter
        public static SqlDataAdapter GetDataAdapter(SqlConnection conn, string commandText, bool isProc = false)
        {
            SqlCommand cmd = CreateCommand(conn, commandText, isProc);
        ...
        public static SqlDataAdapter GetDataAdapter(SqlConnection conn, string commandText, SqlParameter[] sqlParameters, bool isProc = false)
        {
            SqlCommand cmd = CreateCommand(conn, commandText, sqlParameters, isProc);
            SqlDataAdapter adapter = new SqlDataAdapter(cmd);
            return adapter;
